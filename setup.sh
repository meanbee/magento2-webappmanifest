...
composer config repositories.meanbee_webappmanifest '{"type": "path", "url": "/src", "options": {"symlink": true}}'

composer require "meanbee/magento2-webappmanifest" "@dev"
...
magento-command module:enable Meanbee_WebAppManifest
